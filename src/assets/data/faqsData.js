    ...
    list: [
      {
        ...
        ans: 'To receive an invite for Canvas, you can either request one from a creator who isalready on Canvas or send us a request for an invite. Head over towww.canvas.space and press the ‘Request Invite’ button. You could also reach out tous via our social media accounts.'
      },
      {
    ...
    list: [
      {
        ...
        ans: 'A canvas is like a post you create to share your work with the world. It can includetext, images, pdf files, audio, and video content. The striking feature of building aCanvas is the fact that you can micro-monetize your work in seconds and get youraudience to pay directly to you in FIAT and cryptocurrencies.'
      },
      {
